...
for p, q in params:
    ...
    for folder in results_dir.iterdir():
        ...
        # Filter: ignore folders where safety_dataset != "benign"
        if config.get("safety_dataset") != "benign":
            continue
...
discrete_colors = ['#ff7f0e', '#d62728']  # blue, green, orange, red '#1f77b4', '#2ca02c'
...
save_path = Path("plotting/benign.pdf")
